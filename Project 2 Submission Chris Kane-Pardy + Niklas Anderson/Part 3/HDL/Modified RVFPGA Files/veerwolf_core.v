...
`endif
    ...
    inout wire [4:0]   io_btn,
    output wire        o_rgb0_r,
    output wire        o_rgb0_g,
    output wire        o_rgb0_b,
    output wire        o_rgb1_r,
    output wire        o_rgb1_g,
    output wire        o_rgb1_b
    );
...
`else
   ...
   assign i_gpio2[31:5] = 27'b0;
   
   bidirec gpio2_0 (.oe(en_gpio2[0]), .inp(o_gpio2[0]), .outp(i_gpio2[0]), .bidir(io_btn[0]));
   bidirec gpio2_1 (.oe(en_gpio2[1]), .inp(o_gpio2[1]), .outp(i_gpio2[1]), .bidir(io_btn[1]));
   bidirec gpio2_2 (.oe(en_gpio2[2]), .inp(o_gpio2[2]), .outp(i_gpio2[2]), .bidir(io_btn[2]));
   bidirec gpio2_3 (.oe(en_gpio2[3]), .inp(o_gpio2[3]), .outp(i_gpio2[3]), .bidir(io_btn[3]));
   bidirec gpio2_4 (.oe(en_gpio2[4]), .inp(o_gpio2[4]), .outp(i_gpio2[4]), .bidir(io_btn[4]));
...
`endif
  ...
  `endif
   ...
   gpio_top gpio2_module(
    ...
    // RGB PWM Peripheral
    //---------------------------------------------------------
    wb_rgb_pwm rgb_periph (
        .wb_clk_i (wb_clk),
        .wb_rst_i (wb_rst),
    
        .wb_adr_i (wb_m2s_rgb_adr[5:0]),
        .wb_dat_i (wb_m2s_rgb_dat),
        .wb_sel_i (wb_m2s_rgb_sel),
